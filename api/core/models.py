...
class Transaction(models.Model):
    ...
    medium = models.CharField(("Medium"), max_length=50, blank=True, null=True) 
    ...
    payerName = models.CharField(("Payer Name"), max_length=50, blank=True, null=True)
    email = models.CharField(("Email"), max_length=50, blank=True, null=True)
    financialTransId = models.CharField(("financialTransId"), max_length=50, blank=True, null=True)
